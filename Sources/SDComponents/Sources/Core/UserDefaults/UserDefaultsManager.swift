...
public final class UserDefaultsManager {
    ...
    private enum Keys {
        ...
        static let gurardianEmailId = "gurardianEmailId"
    ...
    public var gurardianEmailId: String? {
        get { defaults.string(forKey: Keys.gurardianEmailId) }
        set { defaults.set(newValue, forKey: Keys.gurardianEmailId) }
    }
    ...
    public func clearUserData() {
        defaults.removeObject(forKey: Keys.gurardianEmailId)
